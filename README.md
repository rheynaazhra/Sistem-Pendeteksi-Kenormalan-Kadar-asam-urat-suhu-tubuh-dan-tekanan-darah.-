...
4. Efisiensi Pemantauan
Mengurangi kebutuhan untuk pemeriksaan medis sederhana ke fasilitas kesehatan, sehingga pengguna bisa memantau kesehatan mereka kapan saja dan di mana saja.
...
3. Ketika user memilih cek kesehatan, user akan menginput kadar dari kolesterol, tekanan darah (sistolik dan diastolik), dan asam urat, lalu user akan melihat hasil pemeriksaan apakah kadar didalam tubuhnya termasuk normal atau tidak dan sistem akan memberi rekomendasi obat serta pesan untuk user. 
